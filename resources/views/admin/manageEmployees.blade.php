...
@section('content')
    <div class="m-portlet m-portlet--mobile">
		...
		<div class="m-portlet__body">
			...
			<!--end: Search Form -->
            <!--begin: Datatable -->
			<div class="m_datatable_employee"></div>
			<!--end: Datatable -->
		</div>
	</div>

    <div class="modal fade m-custom-modal" id="m-employee-add-new-modal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				...
				<div class="modal-body">
					...
					<div class="m-wizard m-wizard--1 m-wizard--success m-wizard--step-between" id="m_wizard">
						...
						<div class="m-wizard__form">
							<form class="m-form m-form--label-align-left- m-form--state-" action="{{route('admin.add.new.employee')}}" id="add-new-employee-form" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
								<!--begin: Form Body -->
                                {{ csrf_field() }}
								<div class="m-portlet__body">
...
@section('customScript')
    <script src="/js/datatable/loadEmployeesData.js" type="text/javascript"></script>
    ...
    <script src="/js/addEmployeeWizard.js" type="text/javascript"></script>
