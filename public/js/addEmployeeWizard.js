...
var WizardDemo = function () {
    ...
    var formEl = $('#add-new-employee-form');
    var validator;
    var wizard;
            ...
            if (validator.form()) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        setTimeout(function() {
                            mApp.unprogress(btn);
                            $('#m-employee-add-new-modal').modal('hide');
                            ...
                            final_form.reset();
                            $('#m-employee-add-new-modal').find('.m-build-new-user-profile__tap-li').each(function() {
